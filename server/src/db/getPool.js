    ...
    const { MYSQL_HOST, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DATABASE, MYSQL_ADMIN, MYSQL_ADMIN_PASSWORD, MYSQL_ADMIN_EMAIL } = process.env;
    ...
    export default { getPool, adminConfig };
