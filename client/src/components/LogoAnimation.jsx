...
const LogoAnimation = () => {
    ...
    return (
        <section className="logo-animation-section flex flex-col items-center justify-center bg-sky-700 h-screen">
            <h2 id="first-h2" className="responsive-h2"></h2>
            <div className="logo-container flex items-center justify-center">
                <svg className="responsive-logo w-[60px] h-[60px]" viewBox="0 0 372 345" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 id="second-h2" className="responsive-h2"></h2>
        </section>
    );
};
