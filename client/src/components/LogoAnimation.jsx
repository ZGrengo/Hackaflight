...
const LogoAnimation = () => {
    ...
    return (
        <section className="logo-animation-section relative flex flex-col items-center justify-center bg-medium-blue h-screen">
            <h2 id="first-h2" className='relative bottom-8 z-10 text-5xl font-bold text-white mb-4'></h2>
            <div className="logo-container absolute z-[1] flex items-center justify-center w-80 h-80">
                <svg className="responsive-logo w-full h-full" viewBox="0 0 372 345" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 id="second-h2" className='relative top-8 z-10 text-5xl font-bold text-white mb-4'></h2>
        </section>
    );
};
